...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/recursos/ajustes.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAjustes.setIcon(icon)
        self.actionAjustes.setObjectName(_fromUtf8("actionAjustes"))
        self.actionInformacion = QtGui.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/recursos/icons8-acerca-de-100.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionInformacion.setIcon(icon1)
        self.actionInformacion.setObjectName(_fromUtf8("actionInformacion"))
        self.actionRefresh = QtGui.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/recursos/refrescar.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
